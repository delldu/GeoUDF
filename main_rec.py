...
if __name__ == "__main__":
    ...
    dataset = mesh_pc_dataset(
        arg.data_path,
        mode="train",
        min_num_point=arg.min_num_point,
        max_num_point=arg.max_num_point,
        num_sample=arg.num_sample,
    )
    ...
    dataloader_test = torch.utils.data.DataLoader(
        dataset_test, batch_size=1, shuffle=False, drop_last=False, num_workers=16
    )
    ...
    for epoch in range(arg.max_epoch):
        ...
        log_string(
            "epoch: %03d total loss: %0.7f, cd: %0.7f, l2 dist: %0.7f, udf_grad: %0.7f\n"
